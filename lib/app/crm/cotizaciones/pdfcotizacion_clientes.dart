...
class pdfcotizacion_clientes extends StatefulWidget {
  final List<Lineascoti> lineas;
  ...
  @override
  State<pdfcotizacion_clientes> createState() => _pdfcotizacion_clientesState();
}

class _pdfcotizacion_clientesState extends State<pdfcotizacion_clientes> {
  @override
